...
#' * `groundHeightParam`: Character. The scan parameter name of the polar volume containing ground height information
#' in units of meters relative to mean sea level. Default `HGHT`.
